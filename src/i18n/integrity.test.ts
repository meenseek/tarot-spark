...
const uiCopySchema = {
  ...
  clearQuestionLabel: "string",
  cardCountLabel: "string",
  drawButton: "string",
  drawStatus: "string",
  resultHeading: "string",
  cardOverviewLabel: "string",
  currentReadingSettings: "string",
  customizeCurrent: "string",
  customizeCurrentIntro: "string",
  ...
  copyUrl: "string",
  copiedUrl: "string",
  instagramImageShare: "string",
  instagramImageDownload: "string",
  instagramImagePreparing: "string",
  instagramImageShared: "string",
  instagramImageDownloadStarted: "string",
  instagramImagePrepareFailed: "string",
  kakaoShare: "string",
  kakaoShared: "string",
  share: "string",
  shared: "string",
  promptCopyBlockedAction: "string",
  shareBlockedAction: "string",

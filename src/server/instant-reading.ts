...
연애나 상대의 마음에 관한 주제에서는 제공된 의미가 뒷받침하는 범위에서 상대의 시선, 호감이나 연애적 관심, 망설임을 직접 읽으세요. '카드상 ... 가능성에 무게가 실립니다', '... 쪽으로 읽힐 수 있습니다'처럼 가능성으로 표현하고 현실의 사실처럼 단정하지 마세요.
...
[다음 행동]
[성찰 질문]
전체 흐름은 질문에 대한 카드상 답으로 시작하세요. 연애나 상대 마음 주제라면 첫 두 문장 안에 감정 또는 연애적 관심이 어느 쪽으로 기우는지와 함께 보이는 망설임을 직접 말하고, '알 수 없으니 행동을 보라'는 말로 대신하지 마세요.
...
가능성 A는 '한 가지 해석은 ...일 수 있다는 것입니다.', 가능성 B는 '다른 해석은 ...일 수 있다는 것입니다.'로 시작하세요. 둘은 같은 카드 의미에 근거하지만 결론이 다른 상징적 해석이어야 합니다. 관계 질문에서는 관찰 행동이나 사용자의 대응이 아니라 상대에게 있을 수 있는 서로 다른 감정적·관계적 태도를 설명하세요. 입력에 없는 사례를 붙이지 말며, 둘 다 일부 맞거나 모두 틀릴 수 있게 쓰세요.
...
export function buildInstantReadingPrompt(
  ...
  return [
    ...
    "가장 강한 보강·긴장·진행·통합 관계 하나를 골라 질문에 대한 상징적 답을 먼저 제시하세요. 연애나 상대 마음 주제에서는 카드가 뒷받침하는 시선·호감이나 연애적 관심·망설임을 가능성으로 직접 읽으세요.",
    "같은 의미에 근거한 비예측적 해석 두 개를 비교하되, 관계 질문에서는 서로 다른 감정적·관계적 태도로 쓰세요.",
